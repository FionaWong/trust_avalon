...
(function (window,$,account) {
	...
	//command 实现回调函数的返回码判断
	var responseCodeList =
	{
		ok : '000000',
		noLogin : '900002'
	};
	...
	function invoker(okCommand,nologinCommand,otherCommand){
		this.okCommand = okCommand;
		this.nologinCommand = nologinCommand;
		this.otherCommand = otherCommand;
	}
	invoker.prototype.ok = function(){
		return function(callback){
			this.okCommand.execute(callback);
		}
	}
	invoker.prototype.nologin = function(){
		return function(callback){
			this.nologinCommand.execute(callback);
		}
	}
	invoker.prototype.other = function(){
		return function(callback){
